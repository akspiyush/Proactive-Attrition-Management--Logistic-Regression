...
setwd("D:/ANALYTIX LAB/R/R Final Case Study/Proactive Attrition Management-Logistic Regression Case Study")
...
library(skimr)
skimmed = skim_to_wide(dataAll)  #Summary of data along with histograms
#View(skimmed)
